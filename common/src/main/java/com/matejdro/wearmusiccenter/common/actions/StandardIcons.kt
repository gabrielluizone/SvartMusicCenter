...
object StandardIcons {
    private val iconMap = mapOf(
            StandardActions.ACTION_PLAY to com.matejdro.common.R.drawable.action_play,
            StandardActions.ACTION_PAUSE to com.matejdro.common.R.drawable.action_pause,
            StandardActions.ACTION_SKIP_TO_PREV to com.matejdro.common.R.drawable.action_skip_prev,
            StandardActions.ACTION_SKIP_TO_NEXT to com.matejdro.common.R.drawable.action_skip_next,
            StandardActions.ACTION_VOLUME_UP to com.matejdro.common.R.drawable.action_volume_up,
            StandardActions.ACTION_VOLUME_DOWN to com.matejdro.common.R.drawable.action_volume_down,
